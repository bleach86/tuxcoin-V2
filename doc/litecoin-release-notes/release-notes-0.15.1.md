Tuxcoin Core version *0.15.1* is now available from:

  <https://download.tuxcoin.org/tuxcoin-0.15.1/>
...
A number of changes to the way Tuxcoin Core deals with peer connections and invalid blocks
